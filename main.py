...
class Cactus(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.left < 0 and not self.rewarded:
            self.rewarded = True
            global dino_Performance
            dino_Performance = dino_Performance + 1
            #agent.reward()
            print("rewarded")
    ...
    while not gameQuit:
        ...
        while not gameOver:
            ...
            if playerDino.isDead:
                agent.died( playerDino.isJumping, playerDino.movement[1] >= 0, dino_Performance)
                print("Performance: ", dino_Performance)
                dino_Performance = 0
                gameOver = True
